...
describe('TransactionTable', () => {
    ...
    xit('should calls onEdit', () => {
        ...
        const wrapper = mount(<TransactionTable {...defaultProps} transactions={transactions} onEdit={editSpy} />);
    ...
    xit('should calls onDelete', () => {
        ...
        const wrapper = mount(<TransactionTable {...defaultProps} transactions={transactions} onDelete={deleteSpy} />);
    ...
    xit('should calls onCopy', () => {
        let copySpy = sinon.spy();

        const wrapper = mount(<TransactionTable {...defaultProps} transactions={transactions} onCopy={copySpy} />);
